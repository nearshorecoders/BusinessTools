...
import com.org.pos.catalog.CMetodoPago;
import com.org.pos.catalog.CMoneda;
import com.org.pos.catalog.CPais;
import com.org.pos.catalog.CTipoDeComprobante;
import com.org.pos.catalog.CTipoFactor;
import com.org.pos.catalog.CUsoCFDI;

import java.math.BigDecimal;
import java.util.List;

public class CFDv33FactoryService {
...
//        comp.setCertificado();
        ...
        comp.setMoneda(CMoneda.MXN.value());
        comp.setTipoCambio(new BigDecimal("1"));
        comp.setTotal(new BigDecimal("1798"));
        comp.setTipoDeComprobante(CTipoDeComprobante.I.value());
        comp.setMetodoPago(CMetodoPago.PUE.value());
    ...
    private static Receptor createReceptor(ObjectFactory of) {
        ...
        receptor.setResidenciaFiscal(CPais.MEX.value());
        receptor.setNumRegIdTrib("ResidenteExtranjero1");
        receptor.setUsoCFDI(CUsoCFDI.G_01.value());
        return receptor;
    }
    ...
    private static Concepto.Impuestos createImpuestosConceptos(ObjectFactory of) {
        ...
        tr.setImpuesto("002");
        tr.setTipoFactor(CTipoFactor.TASA.value());
    ...
    private static Impuestos.Traslados createTraslados(ObjectFactory of) {
        ...
        it.setImpuesto("002");
        it.setTipoFactor(CTipoFactor.TASA.value());
